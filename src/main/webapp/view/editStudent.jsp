...
<div class="container mt-5 py-5">
    <div class="row justify-content-center p-5 bg-body shadow rounded border-info border">
        ...
        <h3 class="text-center my-4">Edit Student</h3>
        <c:if test="${success}">
            <c:choose>
        ...
        <div class="col-8">
            <form action="/student?action=edit&id=${element.getId()}" method="post">
                <div class="form-outline mt-3">
                    <input type="text" id="name" name="name" class="form-control" value="${element.getName()}"/>
                    <label class="form-label" for="name">Name</label>
                </div>
                <div class="form-outline mt-3">
                    <input type="date" id="dateOfBirth" name="dateOfBirth" class="form-control" value="${element.getDateOfBirth()}"/>
                    <label class="form-label" for="dateOfBirth">Date of birth</label>
                </div>
                <div class="form-outline mt-3">
                    <input type="text" id="address" name="address" class="form-control" value="${element.getAddress()}"/>
                    <label class="form-label" for="address">Address</label>
                </div>
                <div class="form-outline mt-3">
                    <input type="text" id="phoneNumber" name="phoneNumber" class="form-control" value="${element.getPhoneNumber()}"/>
                    <label class="form-label" for="phoneNumber">Phone Number</label>
                </div>
                <div class="form-outline mt-3">
                    <input type="text" id="email" name="email" class="form-control" value="${element.getEmail()}"/>
